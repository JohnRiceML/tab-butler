...
export type Message =
  ...
  | { type: "DRAFT_REPLY"; author: string; text: string; context?: string; angle?: string; product?: string; steer?: string; style?: string; reason?: string; category?: string; anchor?: string; replyBrief?: string; authorLine?: string; threadLine?: string; opportunityLine?: string }
