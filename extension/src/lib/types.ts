...
export type Message =
  ...
  | { type: "POST_IDEAS"; posts: { author: string; text: string; likes?: number; reposts?: number; followers?: number; shape?: string }[]; ownPosts?: { text: string; likes?: number; reposts?: number }[]; followers?: number }
