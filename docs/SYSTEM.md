...
for t in twttr policy hygiene pacing community momentum learn-stats supporters targets suggest-targets prompts; do node scripts/test-$t.mjs; done   # pure-lib unit tests
